...
// border designs
  static final kPrimaryBorderDesign = Border.all(color: AppColors.kBorderColor);
  static final kSecondaryBorderDesign = Border.all(color: AppColors.kPrimaryButtonColor);
  static final kSuccessBorderDesign = Border.all(color: AppColors.kSuccessColor);
}
